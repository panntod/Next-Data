...
export function Content() {
  return (
    <MainWrapper id='member-tos-content'>
      <Typography size='DISPLAY_MD' className='text-dark'>
      ...
      <Typography size='BODY_MD_NORMAL'>
        The “Next Data Indonesia” entity you are applying to is responsible for controlling the personal data collected
        and how it is used. In some countries, this is referred to as the &quot;controller.&quot;
      </Typography>
      ...
      <Typography size='BODY_LG_BOLDEST'>4. With Whom Does “Next Data Indonesia” Share Your Personal Data?</Typography>
      ...
      <Typography size='BODY_MD_NORMAL'>
        These third parties may process your data on behalf of “Next Data Indonesia” or act as controllers in their own
        right.
      </Typography>
      <Typography size='BODY_LG_BOLDEST'>
