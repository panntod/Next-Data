...
export function Landing() {
  return (
    <MainWrapper
      id="about"
      className="flex flex-col-reverse lg:flex-row justify-between items-center pt-32"
    >
      <SectionWrapper
        id="about-section-2"
      ...
      >
        ...
        {en_about.map(
          ({ number, title, additional_text, additional_class }, index) => (
            <Card
              key={"card-" + index}
              size="small"
              className={["mx-auto justify-start", additional_class].join(" ")}
            >
              <Image
                src="/nextdata.svg"
                alt="nextdata"
              ...
              <div>
                <div className="flex text-secondary-blue">
                  ...
                  {!!additional_text && (
                    <Typography size="DISPLAY_LG">{additional_text}</Typography>
                  )}
                </div>
      ...
      <SectionWrapper id="about-section-1" className="w-full lg:w-[600px] py-6">
        ...
        <Typography size="DISPLAY_SM" className="text-secondary-blue">
          A leading global hub for top freelancers specializing in remote AI
          projects.
        </Typography>
        <Typography size="BODY_MD_NORMAL" className="my-6">
          Founded in 2024, Next Data Indonesia is a fast-growing tech company
          and official partner of leading tech giants. With 55,000+ freelancers
          across 154 countries, we deliver innovative AI solutions and
          comprehensive services, shaping the future with cutting-edge
          technology.
        </Typography>
        <ButtonLink
          variant="primary"
          size="medium"
          href="http://wa.me/6282335692537"
        >
          Get Started Now
        </ButtonLink>
      </SectionWrapper>
