  ...
  return (
    <MainWrapper className='flex flex-col sm:flex-row justify-between items-center'>
      <SectionWrapper className='w-full sm:w-[500px] p-4 sm:p-0'>
        <div className='mb-8'>
          <Typography size='DISPLAY_LG' className='text-secondary-blue text-center sm:text-left'>
            See Our Success Stories
          </Typography>
          <Typography className='my-6 text-xl text-center sm:text-left'>
            NextGenAi dramatically accelerates our go-to-market by cutting data collection time <br /> -{' '}
            <strong>Loly Arianty</strong>
          </Typography>
        </div>
        <div className='text-center sm:text-left'>
          <Typography className='text-secondary-blue font-semibold text-lg'>NextGenAi</Typography>
          <Typography>Innovating The Future</Typography>
        </div>
      </SectionWrapper>

      <SectionWrapper className='w-full sm:w-1/2 relative flex items-center justify-center p-4 sm:p-0'>
        <Image width={500} height={500} src='/testimonial/person.png' alt='person images' className='w-3/4 sm:w-auto' />
        <Image
          width={180}
          height={180}
