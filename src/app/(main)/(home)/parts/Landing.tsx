...
export function Landing() {
  return (
    <MainWrapper
      id="landing"
      className="flex flex-col-reverse sm:flex-row items-center sm:justify-between pt-32"
    >
      <SectionWrapper
        id="landing-section"
      ...
      >
        ...
        <Typography className="my-6">
          Connect with top AI professionals to elevate your projects. Since
          2024, we&apos;ve been innovating and shaping the future through AI
          training and design.
        </Typography>
        <ButtonLink
          variant="primary"
