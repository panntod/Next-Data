...
export function About() {
  return (
    <MainWrapper
      id="about"
      className="flex flex-col lg:flex-row justify-between items-center mb-24"
    >
      <SectionWrapper id="about-section-1" className="w-full lg:w-[600px] py-6">
        ...
        <Typography size="BODY_MD_NORMAL" className="my-6">
          Whether you&apos;re an AI freelancer seeking impactful projects or a
          client in need of innovative solutions, our platform is where
          connections lead to success. Join us today and turn your ideas into
          AI-driven reality.
        </Typography>
      ...
      >
        ...
        <Card
          size="small"
          className="mx-auto sm:mx-0 sm:ml-auto my-6 justify-start"
        >
          <Image
            src="/nextdata-outline.svg"
            alt="nextdata outlined"
