    ...
    <MainWrapper id="why" className="flex flex-col items-center justify-center">
      <SectionWrapper id="why-section-1">
        ...
        <Typography size="BODY_MD_NORMAL" className="my-6 text-center">
          With 55,000+ freelancers in 154 countries, Next Data Indonesia is a
          premier hub for AI projects, offering diverse talent and unmatched
          expertise.
        </Typography>
      </SectionWrapper>
