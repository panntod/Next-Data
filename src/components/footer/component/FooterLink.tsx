    ...
    <>
      <section className="bg-light-blue py-12 flex flex-col sm:flex-row justify-around items-start w-full px-6 sm:px-0">
        <div className="w-full sm:w-1/3 mb-8 sm:mb-0">
          ...
          <Typography>
            Building a smarter tomorrow by connecting AI freelancers with
            clients in need of innovative solutions.
          </Typography>
        </div>
      ...
      <section className="bg-light-blue py-3 w-full text-center">
        <Typography size="SUBTITLE_SM">
          All Right Reserved &copy; {new Date().getFullYear()} Next Data
          Indonesia
        </Typography>
      </section>
    </>
