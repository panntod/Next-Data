...
export const GetInTouch = () => {
  return (
    <>
      <SectionWrapper
        id="get-in-touch-main"
        className="flex flex-col items-center justify-center"
      >
        <SectionWrapper
          id="get-in-touch-section"
          className="flex items-center justify-center w-full max-w-[1250px] h-auto sm:h-[526px] bg-primary-blue rounded-lg sm:rounded-[62px] z-10 p-6 sm:p-0"
        >
          <div className="w-full max-w-[600px] text-center">
            <Typography
              size="DISPLAY_LG"
              className="text-white text-[24px] md:text-5xl"
            >
            ...
            <article className="w-auto h-[60px] flex justify-between px-6 mx-auto rounded-xl sm:rounded-2xl shadow-lg bg-light items-center">
              ...
              <ButtonLink
                variant="secondary"
                size="small"
                href="https://wa.me/6282335692537"
                text="Contact"
              />
            </article>
          </div>
      ...
      <div className="w-full h-32 bg-light-blue -z-10 -mt-24" />
    </>
  );
};
