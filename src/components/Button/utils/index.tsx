...
export const buttonVariants = cva(
  'transition-all duration-300 text-light relative overflow-hidden inline-flex items-center justify-center ease-in-out before:content-[""] before:absolute before:inset-0 before:bg-gradient-to-r disabled:opacity-50 disabled:cursor-not-allowed disabled:pointer-events-none disabled:scale-100 disabled:shadow-none',
  {
    variants: {
      ...
      size: {
        ...
        medium:
          "px-[20px] md:px-[22px] py-[10px] md:py-[12px] text-base rounded-[8px]",
        large:
          "px-[24] md:px-[26px] py-[14px] md:py-[16px] text-lg rounded-[10px]",
      },
    },
    defaultVariants: {
      variant: "primary",
